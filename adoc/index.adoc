...
https://github.com/slowkow/tftargets[**tftargets**] is. shape of the dataframe. 

http://software.broadinstitute.org/gsea/msigdb[**MSigDB**] is. shape of the df. In total the regulation network is shape of the df.
